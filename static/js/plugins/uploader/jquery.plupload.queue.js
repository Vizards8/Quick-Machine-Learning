        ...
        if (e) {
            this.each(function() {
                ...
                function f() {
                    ...
                    c("span.plupload_upload_status", i).text(a("上传 %d/%d 文件").replace(/%d\/%d/, j.total.uploaded + "/" + j.files.length))
                }
                function g() {
                    ...
                    if (!j.files.length && j.features.dragdrop && j.settings.dragdrop) {
                        c("#" + k + "_filelist").append('<li class="plupload_droptext">' + a("拖拽文件上传...") + "</li>")
                    }
                }
                j.bind("UploadFile",
                function(l, m) {
