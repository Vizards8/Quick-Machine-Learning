	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>显示数量:</span> _MENU_",
				"sZeroRecords": "未找到相关记录",
				"sEmptyTable": "您还没有创建过项目",
				"sLoadingRecords": "加载中...",
				...
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='itemsPerPage'>搜索:</span>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "首页",
					"sPrevious": "上一页",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="关键词..." /><div class="srch"></div>';
